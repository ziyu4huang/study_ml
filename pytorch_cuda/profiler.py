...
model = MyModule(180, 10).cuda()
input = torch.rand(128, 180).cuda()
mask = torch.rand((180, 180, 180), dtype=torch.double).cuda()
...
model = MyModule(180, 10).cuda()
input = torch.rand(128, 180).cuda()
mask = torch.rand((180, 180, 180), dtype=torch.float).cuda()
...
model = MyModule(180, 10).cuda()
input = torch.rand(128, 180).cuda()
mask = torch.rand((180, 100, 100), dtype=torch.float).cuda()
