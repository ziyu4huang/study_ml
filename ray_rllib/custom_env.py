# form https://github.com/ray-project/ray/blob/cfc192ebc464ceac77904e7b67cdbe9910876a74/rllib/examples/custom_env.py
...
if __name__ == "__main__":
    ...
    gpu = int(os.environ.get("RLLIB_NUM_GPUS", "0"))
    ...
    if args.local_mode:
        ...
        url = f"ray://{args.server_address or ipv4}:{args.server_port}"
