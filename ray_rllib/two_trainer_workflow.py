# https://github.com/ray-project/ray/blob/87eaf55d82b989c0bd86b4e2d88290974082eb7a/rllib/examples/two_trainer_workflow.py
#
# refer https://docs.ray.io/en/latest/rllib/core-concepts.html

# Check out the PPO + DQN multi-agent workflow example for more details.
...
class MyTrainer(Trainer):
    ...
    def training_iteration(self) -> ResultDict:
        ...
        ppo_train_results = train_one_step(
            self, ppo_train_batch, ["ppo_policy"])
